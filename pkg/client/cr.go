...
type NatsClusterCR interface {
	...
	Create(ctx context.Context, cl *v1.NatsCluster) (*v1.NatsCluster, error)

	// Get returns the specified NATS cluster CR
	Get(ctx context.Context, namespace, name string) (*v1.NatsCluster, error)

	// Delete deletes the specified NATS cluster CR
	Delete(ctx context.Context, namespace, name string) error

	// Update updates the NATS cluster CR.
	Update(ctx context.Context, natsCluster *v1.NatsCluster) (*v1.NatsCluster, error)
}
...
func New(cfg *rest.Config) (*rest.RESTClient, *runtime.Scheme, error) {
	...
	if err := v1.AddToScheme(crScheme); err != nil {
		return nil, nil, err
	}
...
func (c *natsClusterCR) Get(ctx context.Context, namespace, name string) (*v1.NatsCluster, error) {
	result := &v1.NatsCluster{}
...
func (c *natsClusterCR) Update(ctx context.Context, natsCluster *v1.NatsCluster) (*v1.NatsCluster, error) {
	if len(natsCluster.Namespace) == 0 {
		return nil, errors.New("need to set metadata.Namespace in NATS cluster CR")
	}
